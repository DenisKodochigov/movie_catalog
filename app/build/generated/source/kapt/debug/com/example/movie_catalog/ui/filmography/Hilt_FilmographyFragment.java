 ...
 */
public abstract class Hilt_FilmographyFragment extends Fragment implements GeneratedComponentManagerHolder {
  ...
  Hilt_FilmographyFragment() {
    super();
  }

  Hilt_FilmographyFragment(int contentLayoutId) {
  ...
  protected void inject() {
    if (!injected) {
      injected = true;
      ((FilmographyFragment_GeneratedInjector) this.generatedComponent()).injectFilmographyFragment(UnsafeCasts.<FilmographyFragment>unsafeCast(this));
    }
  }
