 ...
 */
public abstract class Hilt_ListPersonFragment extends Fragment implements GeneratedComponentManagerHolder {
  ...
  Hilt_ListPersonFragment() {
    super();
  }

  Hilt_ListPersonFragment(int contentLayoutId) {
  ...
  protected void inject() {
    if (!injected) {
      injected = true;
      ((ListPersonFragment_GeneratedInjector) this.generatedComponent()).injectListPersonFragment(UnsafeCasts.<ListPersonFragment>unsafeCast(this));
    }
  }
