 ...
 */
public abstract class Hilt_ListFilmsFragment extends Fragment implements GeneratedComponentManagerHolder {
  ...
  Hilt_ListFilmsFragment() {
    super();
  }

  Hilt_ListFilmsFragment(int contentLayoutId) {
  ...
  protected void inject() {
    if (!injected) {
      injected = true;
      ((ListFilmsFragment_GeneratedInjector) this.generatedComponent()).injectListFilmsFragment(UnsafeCasts.<ListFilmsFragment>unsafeCast(this));
    }
  }
