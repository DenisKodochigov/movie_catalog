 ...
 */
public abstract class Hilt_ViewerImageFragment extends Fragment implements GeneratedComponentManagerHolder {
  ...
  Hilt_ViewerImageFragment() {
    super();
  }

  Hilt_ViewerImageFragment(int contentLayoutId) {
  ...
  protected void inject() {
    if (!injected) {
      injected = true;
      ((ViewerImageFragment_GeneratedInjector) this.generatedComponent()).injectViewerImageFragment(UnsafeCasts.<ViewerImageFragment>unsafeCast(this));
    }
  }
