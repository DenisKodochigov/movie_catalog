 ...
 */
public abstract class Hilt_KitFilmsFragment extends Fragment implements GeneratedComponentManagerHolder {
  ...
  Hilt_KitFilmsFragment() {
    super();
  }

  Hilt_KitFilmsFragment(int contentLayoutId) {
  ...
  protected void inject() {
    if (!injected) {
      injected = true;
      ((KitFilmsFragment_GeneratedInjector) this.generatedComponent()).injectKitFilmsFragment(UnsafeCasts.<KitFilmsFragment>unsafeCast(this));
    }
  }
