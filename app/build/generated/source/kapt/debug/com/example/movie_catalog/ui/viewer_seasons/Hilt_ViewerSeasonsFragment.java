 ...
 */
public abstract class Hilt_ViewerSeasonsFragment extends Fragment implements GeneratedComponentManagerHolder {
  ...
  Hilt_ViewerSeasonsFragment() {
    super();
  }

  Hilt_ViewerSeasonsFragment(int contentLayoutId) {
  ...
  protected void inject() {
    if (!injected) {
      injected = true;
      ((ViewerSeasonsFragment_GeneratedInjector) this.generatedComponent()).injectViewerSeasonsFragment(UnsafeCasts.<ViewerSeasonsFragment>unsafeCast(this));
    }
  }
