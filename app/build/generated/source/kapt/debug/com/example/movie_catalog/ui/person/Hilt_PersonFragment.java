 ...
 */
public abstract class Hilt_PersonFragment extends Fragment implements GeneratedComponentManagerHolder {
  ...
  Hilt_PersonFragment(int contentLayoutId) {
  ...
  protected void inject() {
    if (!injected) {
      injected = true;
      ((PersonFragment_GeneratedInjector) this.generatedComponent()).injectPersonFragment(UnsafeCasts.<PersonFragment>unsafeCast(this));
    }
  }
