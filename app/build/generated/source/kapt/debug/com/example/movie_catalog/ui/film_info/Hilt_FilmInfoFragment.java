 ...
 */
public abstract class Hilt_FilmInfoFragment extends Fragment implements GeneratedComponentManagerHolder {
  ...
  Hilt_FilmInfoFragment() {
    super();
  }

  Hilt_FilmInfoFragment(int contentLayoutId) {
  ...
  protected void inject() {
    if (!injected) {
      injected = true;
      ((FilmInfoFragment_GeneratedInjector) this.generatedComponent()).injectFilmInfoFragment(UnsafeCasts.<FilmInfoFragment>unsafeCast(this));
    }
  }
