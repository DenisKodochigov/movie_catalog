...
//        collection?.let {
//            holder.binding.checkBox.text = collection.collection?.name ?: ""
//            holder.binding.tvCount.text = collection.collection?.count.toString()
//            holder.binding.checkBox.isChecked = collection.collection?.included ?: false
